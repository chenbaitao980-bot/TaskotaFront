...
This project is indexed by GitNexus as **smart-assistant** (1049 symbols, 1815 relationships, 7 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
