...
This project is indexed by GitNexus as **smart-assistant** (3368 symbols, 6189 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
