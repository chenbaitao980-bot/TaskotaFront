...
This project is indexed by GitNexus as **smart-assistant** (3269 symbols, 6156 relationships, 197 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
